...
def test_format_display_title():
    ...
    assert format_display_title("Superstore, Season 4") == "Superstore, Season 4"
    assert format_display_title("The Mentalist", season=1) == "The Mentalist, Season 1"
    assert format_display_title("the mentalist", season=2) == "The Mentalist, Season 2"
    assert format_display_title("The Mentalist, Season 1", season=1) == "The Mentalist, Season 1"
    assert format_display_title("Inception", season=None) == "Inception"
